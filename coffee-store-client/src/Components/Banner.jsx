  ...
  return (
    <div className='bg-[url("https://i.ibb.co/Dgw4WDdn/3.png")] bg-cover bg-no-repeat flex sm:justify-end justify-center sm:py-[288px] py-[100px] sm:h-[800px] w-full px-4'>
        <div className='sm:w-[724px] w-full'>
            ...
            <button className='btn bg-[#E3B577] py-4 px-8 text-[#242222] mt-4 mb-12 sm:text-xl text-base 
            rancho hover:bg-transparent hover:border hover:border-white hover:text-white transition-all duration-300 ease-in-out'>
              Learn More
              </button>
        </div>
    </div>
