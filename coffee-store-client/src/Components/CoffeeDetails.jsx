    ...
    <div  className=' bg-[url("https://i.ibb.co/PGs7WVtP/11.png")] bg-no-repeat md:px-[112px] pb-[120px]'>
       ...
       <div  className='max-w-7xl mx-auto md:px-[112px] py-[70px] bg-[#F4F3F0] flex flex-col sm:flex-row gap-10 justify-center items-center'>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <p className='text-xl text-[#5C5B5B]'><span className='font-semibold text-[#1B1A1A] mr-2'>Supplier:</span> {coffee.supplier}</p>
                <p className='text-xl text-[#5C5B5B]'><span className='font-semibold text-[#1B1A1A] mr-2'>Taste:</span>{coffee.taste}</p>
                <p className='text-xl text-[#5C5B5B]'><span className='font-semibold text-[#1B1A1A] mr-2'>Price:</span>{price}</p>
                <p className='text-xl text-[#5C5B5B]'><span className='font-semibold text-[#1B1A1A] mr-2'>Details:</span>{coffee.details}</p>
            </div>
       </div>
    </div>
  )
